import type { BuilderProject, CoordinateMode, SurveyPoint } from "./types";

const metersPerDegreeLatitude = 111_320;

export const localOffsetToLatLon = (
  latitude: number,
  longitude: number,
  xMeters: number,
  yMeters: number,
...
export const latLonToLocalOffset = (
  latitude: number,
  longitude: number,
...
export const normalizeStationPosition = (point: SurveyPoint, project: BuilderProject) => {
